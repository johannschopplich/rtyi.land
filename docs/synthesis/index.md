...
This section contains **curated, cross-stream synthesis** – focused briefings distilled from all 205 stream analyses for documentary work.
...
| ----------------------------------------------- | ---------------------------------------------- | ----------------------------------- |
| [**Interview Prep**](/synthesis/interview-prep) | Curated questions per interviewee, prioritized | Direct interview preparation        |
| [**Story Highlights**](/synthesis/stories)      | Narrative arcs ranked by documentary potential | Documentary arc planning            |
| [**Curated Quotes**](/synthesis/quotes)         | Quotes tagged by use case                      | Narration, trailers, chapter titles |
...
The synthesis above is built from the per-stream extractions. You can always drill into the raw data:

- [Stream Dashboard](/streams/) – all 205 streams overview
