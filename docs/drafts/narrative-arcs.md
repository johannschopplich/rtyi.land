...
**Central Theme:** The vision and mindset required to begin a project of this scale.
...
- **Key Content:**
  ...
  - ~~The role of the SM64 decompilation project as the catalyst that made this technically possible.~~
- **B-Roll:**
  - RTYI gameplay juxtaposed with classic SM64 footage.
  - Archival footage of the N64 console.

### Kaze's Philosophy

- **Narrative Goal:** Define Kaze's principles of game design.
- **Key Content:**
  - **Core Principles:** Explore his key philosophies: "excitement over difficulty," creating a "feeling" and "placeness,", avoiding "modern game design" tropes, and his critique of "safe" AAA games.
  - **Evolution as a Designer:** Contrast RTYI with "Last Impact." Use his quote: "Back when I making last impact I just like whenever I had an idea i would just put it in almost like unfiltered." How has his approach matured?
...
- **B-Roll:**
  ...
  - Gameplay from various courses that exemplifies his design principles.
...
- **Key Content:**
  ...
  - **The Process:** Explore the back-and-forth between Kaze's technical needs and Biobak's artistic vision, especially for unique themes like the "craft" aesthetic.
  - **Beyond Models:** Highlight his role as an idea contributor, suggesting level flow concepts and giving real-time feedback in chat.
- **B-Roll:**
...
- **Key Content:**
  ...
  - **Technical Artistry:** The challenge of composing for the N64's limited sound font and the ambition of a dynamic overworld with nearly 20 seamlessly transitioning tracks.
...
- **Narrative Goal:** Highlight Zeina's multifaceted role in providing animation, art, and playtesting feedback.
- **Key Content:**
  - **Animation:** Showcase her process for a key character, like the Wiggler or the "Piano Guy," conveying personality within N64 constraints.
  - **Beyond Animation:** Her contributions to models (Peach, Toad, signs) and textures (bunny footprints).
...
::: tip Highlight
This is my favorite arc. It perfectly captures Kaze's creative process and the team's collaborative synergy.
:::
...
- **Key Content:**
  ...
  - **Collaboration:** Biobak's real-time suggestions helping Kaze iterate, while Zeina's animations populate the world (Dry Bones, Piano Guy).
- **B-Roll:**
...
- **Key Content:**
  ...
  - **Community Contribution:** Leila and others providing doodles and models.
...
- **Key Content:**
  ...
  - **The Pivot:** The live brainstorming session that leads to the "Shy Guy Space Station," a more original and fitting concept. This highlights the commitment to quality over sunk costs.
- **B-Roll:**
...
- **Key Content:**
  - **The Problem:** Limitations of the original code. The sound engine is "fucked," the vanilla collision is "unusable."
  - **The Solution:** Frame each overhaul as a response to a creative need:
    - **New Sound Engine:** For dynamic, seamless music.
    - **New Collision System:** For stable, consistent movement.
...
- **B-Roll:**
  ...
  - Kaze looking at performance profiler data.
...
- **Key Content:**
  ...
  - **Narrative Gating:** The evolution of the Dory rescue mechanic from a simple coin payment to a story-driven event.
- **B-Roll:**
...
- **Key Content:**
  - Kaze's critique of repetitive 100-Coin Stars.
  - **Yoshi Coins:** Rewards for "special interactions" and exploration, not just collection.
  - **The Global Economy:** Coins are a currency to _change the world_, making them "feel more valuable than Mario Odyssey."
...
- **Key Content:**
  - **Creative Partnership:**
    - Zeina's direct artistic contributions: the "mutant Yoshi" concept, zoo entrance drawings, textures.
  ...
  - **Life & Parenthood:**
    - Ground the project in reality with anecdotes: making terrariums, haircuts, etc.
...
**Central Theme:** The personal and technical challenges that define a project of this scale.
...
- **Key Content:**
  ...
  - **Emulator Hell:** The frustration of bugs that only appear on certain emulators or on real hardware.
  - **F3DX3:** The collaboration with Soren to fix the performance of a new microcode.
- **B-Roll:**
  - Game crashing on N64 hardware.
  - Kaze looking stressed.
  - The performance profiler on screen showing red bars.
  - ~~Discord chats with Soren.~~

### The Human Cost

- **Narrative Goal:** Ground the immense project in human reality.
- **Key Content:**
  - **The Financial Reality:** Kaze's sincerity about the project's opportunity cost ("tens of thousands") and his reliance on sponsorships.
...
- **Narrative Goal:** Explain the dynamic of building a game live on stream.
- **Key Content:**
  ...
  - **Open Source:** His plan to release the engine and source code, and his hopes for how the community will use it.
- **B-Roll:**
...
- **Key Content:**
  ...
  - **The Contingency Plan:** The plan to asset-swap and create an original IP (["legally distinct" version](/streams/gemini-2-5-pro-preview-05-06-20250319#business-aspects)) if a C&D is issued.
